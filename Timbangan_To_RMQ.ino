 ...
 */
const char* wifiSsid              = "redmi"; // Deklarasi nama Wifi
const char* wifiPassword          = "smknegeri1cimahi"; // Deklarasi untuk Password Wifi
 ...
 * 
 */
int deviceDout                   = 4; // Deklarasi Pin 4 (16=4)
int deviceSck                    = 12; // Deklarasi Pin 12 (14=5)
String deviceGuid                = "735a1d19-dd67-4e2e-9fff-cf7287123357"; //dapatkan guid generator dari link guidgenerator.com
